...
export function Safari({
  imageSrc,
  videoSrc,
  url = "portfolio.mrinalkapoor.dev",
  width = 1203,
  height = 753,
  mode = "default",
  children,
    ...
    <div className="w-full overflow-hidden">
      ...
      >
        <g clipPath="url(#path0)">
          ...
          {/* Content Area */}
          <foreignObject x="2" y="54" width="1198" height="696" clipPath="url(#roundedBottom)">
            <div className="h-full w-full flex flex-col justify-start overflow-hidden">{children}</div>
          </foreignObject>
